...
class Level_1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "left",
      "./assets/Platformer/Base pack/Tiles/grassLeft.png"
    );
    this.load.image("mid", "./assets/Platformer/Base pack/Tiles/grassMid.png");
    this.load.image(
      "right",
      "./assets/Platformer/Base pack/Tiles/grassRight.png"
    );
    this.load.image(
      "mud",
      "./assets/Platformer/Base pack/Tiles/grassCenter.png"
    );
    this.load.image(
      "brown_tall",
      "./assets/Platformer/Mushroom expansion/PNG/tallShroom_brown.png"
    );
    this.load.image(
      "red_tall",
      "./assets/Platformer/Mushroom expansion/PNG/tallShroom_red.png"
    );
    this.load.image(
      "tan_tall",
      "./assets/Platformer/Mushroom expansion/PNG/tallShroom_tan.png"
    );
    this.load.image(
      "brown_short",
      "./assets/Platformer/Mushroom expansion/PNG/tinyShroom_brown.png"
    );
    this.load.image(
      "mushroom_bush",
      "./assets/Platformer/Mushroom expansion/PNG/bush.png"
    );
    this.load.image(
      "brick_platform",
      "./assets/Platformer/Base pack/Tiles/castleHalf.png"
    );
    this.load.image(
      "small_bricks",
      "./assets/Platformer/Base pack/Tiles/brickWall.png"
    );
    ...
    this.load.image(
      "pp_plant",
      "./assets/Platformer/Base pack/Items/plantPurple.png"
    );
  ...
  create() {
    ...
    p4.alpha = 0.8;
    let p5 = this.matter.add
      .image(495, 400, "pp_plant", null, {
        isStatic: true,
        isSensor: true,
        angle: 0.4,
      })
  ...
  level_platforms() {
    ...
    gate = this.matter.add
      .image(375, 490, "brick_platform", null, {
        isStatic: true,
        friction: 0.2,
        restitution: 0.8,
      })
      .setScale(1.1, 0.15);
    this.matter.add
      .image(200, 295, "small_bricks", null, {
        isStatic: true,
        friction: 0.5,
        restitution: 0.8,
      })
    ...
    this.matter.add
      .image(550, 175, "small_bricks", null, {
        isStatic: true,
        friction: 0.5,
        restitution: 0.8,
      })
