...
class Level_3 extends Phaser.Scene {
  ...
  preload() {
    this.load.audio(
      "theme2",
      "./assets/HappyLoops/HappyLoops/firm-walking.wav"
    );
    ...
    this.load.image(
      "left",
      "./assets/Platformer/Candy expansion/Tiles/chocoLeft.png"
    );
    this.load.image(
      "mid",
      "./assets/Platformer/Candy expansion/Tiles/chocoMid.png"
    );
    this.load.image(
      "right",
      "./assets/Platformer/Candy expansion/Tiles/chocoRight.png"
    );
    this.load.image(
      "mud",
      "./assets/Platformer/Candy expansion/Tiles/cakeHalfAltMid.png"
    );
    this.load.image(
      "candyBlue",
      "./assets/Platformer/Candy expansion/Tiles/candyBlue.png"
    );
    this.load.image(
      "candyGreen",
      "./assets/Platformer/Candy expansion/Tiles/candyGreen.png"
    );
    this.load.image(
      "candyRed",
      "./assets/Platformer/Candy expansion/Tiles/candyRed.png"
    );
    this.load.image(
      "candyYellow",
      "./assets/Platformer/Candy expansion/Tiles/candyYellow.png"
    );
    this.load.image(
      "base1",
      "./assets/Platformer/Candy expansion/Tiles/lollipopBaseCake.png"
    );
    this.load.image(
      "base2",
      "./assets/Platformer/Candy expansion/Tiles/lollipopBasePink.png"
    );
    this.load.image(
      "base",
      "./assets/Platformer/Candy expansion/Tiles/lollipopBase.png"
    );
    this.load.image(
      "lpgreen",
      "./assets/Platformer/Candy expansion/Tiles/lollipopWhiteGreen.png"
    );
    this.load.image(
      "lpred",
      "./assets/Platformer/Candy expansion/Tiles/lollipopWhiteRed.png"
    );
    this.load.image(
      "cone",
      "./assets/Platformer/Candy expansion/Tiles/cupCake.png"
    );
    this.load.image(
      "icecream",
      "./assets/Platformer/Candy expansion/Tiles/creamVanilla.png"
    );
    this.load.image(
      "brick_platform",
      "./assets/Platformer/Candy expansion/Tiles/chocoCenter.png"
    );
    this.load.image(
      "small_bricks1",
      "./assets/Platformer/Candy expansion/Tiles/cookieChoco.png"
    );
    this.load.image(
      "small_bricks2",
      "./assets/Platformer/Candy expansion/Tiles/cookieBrown.png"
    );
    ...
    this.load.image(
      "exit_sign",
      "./assets/Platformer/Candy expansion/Tiles/canePinkSmall.png"
    );
  ...
  create() {
    ...
    this.add.image(70, 455, "cone").setScale(1, 1).setAlpha(0.8);
    this.add.image(70, 385, "icecream").setScale(1, 1).setAlpha(0.8);
    this.add.image(10, 455, "candyRed").setScale(1, 1).setAlpha(0.9);
    this.add.image(60, 455, "candyBlue").setScale(1, 1).setAlpha(0.9);
    this.add.image(110, 455, "candyGreen").setScale(1, 1).setAlpha(0.9);
    this.add.image(160, 455, "candyYellow").setScale(1, 1).setAlpha(0.9);

    this.add.image(460, 190, "base").setScale(1.5, 2).setAlpha(0.5);
    this.add.image(460, 400, "base1").setScale(1.5, 4).setAlpha(0.5);
    this.add.image(460, 70, "lpgreen").setScale(1.5, 1.5).setAlpha(0.8);

    this.add.image(520, 190, "base").setScale(1.5, 2).setAlpha(0.5);
    this.add.image(520, 400, "base2").setScale(1.5, 4).setAlpha(0.5);
    this.add.image(520, 70, "lpred").setScale(1.5, 1.5).setAlpha(0.8);

    this.matter.add
      .image(680, 460, "exit_sign", null, {
        isStatic: true,
        angle: 0,
        alpha: 0.2,
        isSensor: true,
    ...
    for (var i = 0; i < 1; i++) {
      // 0xFF44FF
      var poly = this.add.polygon(600 + 200 * i, 560, basket, 0x000000, 0.8);
      baskets.push(poly);
      this.matter.add
        .gameObject(poly, {
          shape: {
    ...
    num_score = 1;
    den_score = current_question.denominator - 3;
  ...
  ball_creator() {
    ...
    ball = this.matter.add.sprite(200, 45, "player").setScale(0.8, 0.75); //make player1 body with physics enabled
    ball.fstatic = 1;
  ...
  level_platforms() {
    ...
    gate = this.matter.add
      .image(600, 495, "brick_platform", null, {
        isStatic: true,
        friction: 0.2,
        restitution: 0.8,
      })
    ...
    // brick platform
    let p1 = this.matter.add
      .image(150, 160, "small_bricks2", null, {
        isStatic: true,
        friction: 0.5,
        restitution: 0.8,
      })
    ...
    let p2 = this.matter.add
      .image(600, 270, "small_bricks1", null, {
        isStatic: true,
        friction: 0.5,
        restitution: 0.8,
      })
    ...
    let p3 = this.matter.add
      .image(180, 375, "small_bricks2", null, {
        isStatic: true,
        friction: 0.5,
        restitution: 0.8,
      })
  ...
  text_creator() {
    ...
    const ans1 = this.add.rectangle(150, 100, 50, 50, 0x2f434c, 0.7);
    ...
    const ans2 = this.add.rectangle(180, 325, 50, 50, 0x2f434c, 0.7);
    const body2 = this.matter.add.rectangle(180, 325, 50, 50, {
      isStatic: true,
      restitution: 1,
      isSensor: true,
    });
    ...
    text1 = this.add.text(170, 295, text1_num + "\n" + text1_den, {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: 25,
      align: "center",
    });
    ...
    const ans3 = this.add.rectangle(600, 220, 50, 50, 0xf26419, 0.7);
    const body3 = this.matter.add.rectangle(600, 220, 50, 50, {
      isStatic: true,
      restitution: 1,
      isSensor: true,
    });
    ...
    text2 = this.add.text(595, 190, text2_num + "\n" + text2_den, {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: 25,
      align: "center",
    });
  ...
  powerups() {
    // create + ball
    let circle1 = this.add.circle(60, 160, 22, 0x12191d);
    let body1 = this.matter.add.circle(60, 160, 22);
    let add = this.matter.add.gameObject(circle1, body1);
    body1.restitution = 0.8;
    body1.isStatic = true;
    body1.isSensor = true;
    var pls_img = this.matter.add
      .image(60, 160, "plus", null, {
        isStatic: true,
        isSensor: true,
      })
    ...
    // create - ball
    let circle2 = this.add.circle(375, 385, 22, 0x12191d);
    let body2 = this.matter.add.circle(375, 385, 22);
    let sub = this.matter.add.gameObject(circle2, body2);
    body2.restitution = 0.8;
    body2.isStatic = true;
    body2.isSensor = true;
    var min_img = this.matter.add
      .image(375, 385, "minus", null, {
        isStatic: true,
        isSensor: true,
      })
      .setScale(0.065, 0.065);
    ...
    // create * ball
    let circle3 = this.add.circle(700, 350, 22, 0x12191d);
    let body3 = this.matter.add.circle(700, 350, 22);
    let mult = this.matter.add.gameObject(circle3, body3);
    body3.restitution = 0.8;
    body3.isStatic = true;
    body3.isSensor = true;
    var mult_image = this.matter.add
      .image(700, 350, "multiply", null, {
        isStatic: true,
        isSensor: true,
      })
      .setScale(0.065, 0.065);
