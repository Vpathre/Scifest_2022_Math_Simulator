...
class Level_3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.matter.add.image(680, 460, 'exit_sign', null, {
            isStatic: true,
            angle: 0,
            alpha: 0.2,
            isSensor: true
        ...
        document.getElementById("reset_button").addEventListener("click", this.reset_counter);
    }
    ...
    level_platforms() {
        ...
        this.matter.add.image(675, 525, 'left', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(745, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        ...
        // Basic platform left
        this.matter.add.image(525, 525, 'right', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(455, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(385, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(315, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(245, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(175, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(105, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        this.matter.add.image(35, 525, 'mid', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1);
        ...
        // Bottom right
        this.matter.add.image(675, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(745, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        ...
        // Bottom left
        this.matter.add.image(525, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(455, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(385, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(315, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(245, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(175, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(105, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        this.matter.add.image(35, 595, 'mud', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(1, 1.2);
        ...
        gate = this.matter.add.image(600, 495, 'brick_platform', null, {
            isStatic: true,
            friction: 0.2,
            restitution: 0.8
        }).setScale(0.95, 0.15);
        ...
        // brick platform
        let p1 = this.matter.add.image(150, 160, 'small_bricks2', null, {
            isStatic: true,
            friction: 0.5,
            restitution: 0.8
        }).setScale(1, 1);

        let p2 = this.matter.add.image(600, 270, 'small_bricks1', null, {
            isStatic: true,
            friction: 0.5,
            restitution: 0.8
        }).setScale(1, 1);

        let p3 = this.matter.add.image(180, 375, 'small_bricks2', null, {
            isStatic: true,
            friction: 0.5,
            restitution: 0.8
        }).setScale(1, 1);
    ...
    block_creator(number, numerator, total) {
        ...
        for (let i = 0; i < total; i++) {
            ...
            // if the block is a numerator, color it
                ...
                const ans = this.add.rectangle(600 + (200 * number), 580 - (10 * i), 60, Math.floor(90 / total), 0x000000);
                const body = this.matter.add.rectangle(600 + (200 * number), 580 - (10 * i), 60, Math.floor(90 / total), {
                    isStatic: false,
                    restitution: 1
                });
            ...
            // if denominator, colour it white or something else
                ...
                const ans = this.add.rectangle(600 + (200 * number), 580 - (10 * i), 60, Math.floor(90 / total), 0xFFFFFF);
                const body = this.matter.add.rectangle(600 + (200 * number), 580 - (10 * i), 60, Math.floor(90 / total), {
                    isStatic: false,
                    restitution: 1
                });
    ...
    powerups() {
        ...
        body1.isStatic = true;
        body1.isSensor = true;
        var pls_img = this.matter.add.image(60, 160, 'plus', null, {
            isStatic: true,
            isSensor: true
        ...
        body2.isStatic = true;
        body2.isSensor = true;
        var min_img = this.matter.add.image(375, 385, 'minus', null, {
            isStatic: true,
            isSensor: true
        }).setScale(0.065, 0.065);
        ...
        body3.isStatic = true;
        body3.isSensor = true;
        var mult_image = this.matter.add.image(700, 350, 'multiply', null, {
            isStatic: true,
            isSensor: true
        }).setScale(0.065, 0.065);
    ...
    fraction_arithmatic(operation, local_num, local_den) {
        ...
        // big denominator; small numerator
            ...
            den_score /= num_score;
            num_score /= temp_num;
        } else if (math.gcd(num_score, den_score) < Math.max(num_score, den_score)) {
