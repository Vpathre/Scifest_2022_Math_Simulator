...
function identifier(type, t1, t2, t3) {
  if (type == "angle") {
    ...
    //right
      ...
      document.getElementById("angles").style.color = '0x4CC7E6';
    }
    //acute
    else if (t1 < 90 || t2 < 90 || t3 < 90) {
    ...
    if (t1 == t2 && t2 == t3) {
      ...
      document.getElementById("sides").style.color = '0x63B616';
    }
    // isosceles
    ...
    //scalene
      ...
      document.getElementById("sides").style.color = '0xEB18F2';
    }
  }
}
